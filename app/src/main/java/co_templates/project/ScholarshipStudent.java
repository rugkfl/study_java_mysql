...
public class ScholarshipStudent {
    ...
    public ScholarshipStudent(int student_no, String student_name, float avg, String scholar_name, float percent, int scholar_money) {
        super();
